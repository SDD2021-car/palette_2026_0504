...
folder_path = '/data/yjy_data/SAM2/hint_outputs_train/hint_mask_binary'
...
# from PIL import Image
#
# folder_path = '/data/yjy_data/SAM2/hint_outputs_test/hint_mask_binary'
#
# for filename in os.listdir(folder_path):
#     if filename.lower().endswith('.png'):
#         img_path = os.path.join(folder_path, filename)
...
# from PIL import Image
# import os
# INPUT_DIR = Path("/data/yjy_data/SAM2/hint_outputs_test_scene_histogram0.6/color_hint_by_dots")  # 这里放jpg根目录
# OUTPUT_DIR = Path("/NAS_data/yjy/palette_color_hint/color_hint_data/color_hint_by_dots/test")  # 输出png根目录
#
#
